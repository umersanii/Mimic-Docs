...
On boot, every servo is immediately written to `180` (fully open) before the main loop starts, so
the hand always powers up in a known, fully-extended position rather than wherever it last was
